<?php $__env->startSection('content'); ?>
    <div class="container w-50 px-4 py-4 rounded-4 bg-light halaman-edit">
        <h2 class="pb-4 text-center">Edit Barang</h2>
        <div>
            <form class="row g-3" action="<?php echo e(route('barangs.update', $dt_barang->id)); ?>" method="POST">
                <?php echo csrf_field(); ?>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\Laravel\masterBarangUts\resources\views/listBarang/edit.blade.php ENDPATH**/ ?>