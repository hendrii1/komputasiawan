<?php $__env->startSection('content'); ?>
    <div class="container w-50 px-4 py-4 rounded-4 bg-light halaman-detail">
        ...
        <div>
            <form class="row g-3">
                ...
                <div class="col-md-6">
                    ...
                    <input type="number" name="harga_barang" value="<?php echo e(number_format($dt_barang->harga_barang, 0, ',', '.')); ?>"  class="form-control" id="harga_barang" readonly>
                </div>
                <div class="col-md-6">
                ...
                <div class="col-12">
                    <a class="btn btn-success px-4 mt-3" href="<?php echo e(route('barangs.index')); ?>">Kembali</a>
                </div>
            </form>
        </div>
    </div>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\Laravel\masterBarangUts\resources\views/listBarang/show.blade.php ENDPATH**/ ?>