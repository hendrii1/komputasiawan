        ...
        <div>
            <form class="row g-3">
                ...
                <div class="col-md-6">
                    ...
                    <input type="number" name="harga_barang" value="{{ number_format($dt_barang->harga_barang, 0, ',', '.') }}"  class="form-control" id="harga_barang" readonly>
                </div>
                <div class="col-md-6">
                ...
                <div class="col-12">
                    <a class="btn btn-success px-4 mt-3" href="{{route('barangs.index')}}">Kembali</a>
                </div>
            </form>
        </div>
    </div>
